...
def get_params_water_world(experiment):
    step_unit = 1000
...
def run_experiment(world, alg_name, experiment, num_times, show_print):
    ...
    if world == 'waterworld':
        testing_params, learning_params, tester, curriculum = get_params_water_world(experiment)
...
if __name__ == "__main__":
    ...
    run_experiment(world, alg_name, experiment, num_times, show_print)
